          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div className="border border-gray-100 p-6 mb-6">
                ...
                <p className="text-[20px] tracking-[0.3em] uppercase text-whitebold-500 mb-1" style={{ fontFamily: "Inter, sans-serif" }}>Maine Retreat</p>
              ...
              <div className="space-y-3">
                <a href="tel:1207-890-6179" className="flex items-center gap-3 text-3sm text-gray-700 hover:text-black transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <section className="bg-black text-white py-12 px-6">
        <div className="max-w-7xl mx-auto grid sm:grid-cols-3 gap-8 text-center">
          {[
            ...
            { icon: "🐕", title: "Pet Friendly", sub: "Perimeter fence planned. 2 acres to roam." },
